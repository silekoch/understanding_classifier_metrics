...
export const CONTROL_SPECS = {
  ...
  p0Neg: { type: "range", min: 0, max: 0.95, step: 0.01, default: 0.42, reactive: true, preset: true },
  p0Pos: { type: "range", min: 0, max: 0.95, step: 0.01, default: 0.12, reactive: true, preset: true },
  zeroValue: { type: "range", min: -3, max: 3, step: 0.05, default: 0, reactive: true, preset: true },
  alphaNeg: { type: "range", min: 0.2, max: 20, step: 0.1, default: 2, reactive: true, preset: true },
  betaNeg: { type: "range", min: 0.2, max: 20, step: 0.1, default: 8, reactive: true, preset: true },
  alphaPos: { type: "range", min: 0.2, max: 20, step: 0.1, default: 8, reactive: true, preset: true },
  betaPos: { type: "range", min: 0.2, max: 20, step: 0.1, default: 2, reactive: true, preset: true },
  epsPos: { type: "range", min: 0, max: 0.45, step: 0.01, default: 0.12, reactive: true, preset: true },
  epsNeg: { type: "range", min: 0, max: 0.45, step: 0.01, default: 0.08, reactive: true, preset: true },
  confSharpness: {
    type: "range",
    min: 2,
    max: 40,
